...
const ProgramaAdaptacaoSection = () => {
  const beneficios = [
    {
      icon: Microscope,
      title: "Análise Profunda do Corpo",
      description: "Identificação precisa de desequilíbrios e potenciais riscos"
    },
    {
      icon: Activity,
      title: "Ciência e Tecnologia Integradas",
      description: "Equipamentos de última geração e interpretação profissional"
    },
    {
      icon: Target,
      title: "Plano Funcional Personalizado",
      description: "Recomendações e ajustes conforme seu perfil metabólico"
    }
  ];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-12 text-white/90 text-center md:text-left">
            Conheça o <strong>Checkup Funcional</strong>: tecnologia de ponta para revelar como seu corpo está funcionando e otimizar sua saúde de forma completa e personalizada.
          </p>
